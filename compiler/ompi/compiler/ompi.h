...
/* DF-C */
extern aststmt dfc_all_df_function_tree;
extern aststmt dfc_main_subtree_for_ad;
extern aststmt dfc_main_subtree_for_fn;
...
extern aststmt parse_file(char *fname, int *error); //ljr
