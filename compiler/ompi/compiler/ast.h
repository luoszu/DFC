...
enum decltype { DIDENT = 1, DPAREN, DARRAY, DFUNC, DINIT,
                ...
                DSTRUCTFIELD, DCASTTYPE, DLIST, DDFCFUNC
              } ;
...
extern astdecl DfcFuncDecl(astdecl decl, dfcvar var);
extern dfcvar DfcMakeVars(astdecl inParams, astdecl outParams);
...
/* DF-C */
// NOTE(luobin): made a new API to get the identifier name of a astdecl directly.
extern char *dfc_get_decl_identifier_name(astdecl node);
